...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def action(self, gamestate):
        ...
        if self.imposter:
            ...
            # DOUBLING DAMAGE. While there is a place behind the queen, check if that place has an ant. If the ant in that place has not been damage-doubled already, double its damage. And add it to the damage-doubled list. Repeat until there is no place  behind the ant.
