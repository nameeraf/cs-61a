...
def swine_align(player_score, opponent_score):
    ...
    False
    """
    potential_gcd = min(player_score, opponent_score)
    final_gcd = 0
    # BEGIN PROBLEM 4a
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while (score0 < goal) and (score1 < goal):
        if who == 0:
            ...
            repeat_turn = extra_turn(score0, score1)
        elif who == 1:
            num_rolls = strategy1(score1, score0)
            score1 += take_turn(num_rolls, score0, dice)
            repeat_turn = extra_turn(score1, score0)
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if (score_difference > running_high):
            print(score_difference, 'point(s)! The most yet for Player', who)
            return announce_highest(who, score, score_difference)
        else:
...
def make_averaged(original_function, trials_count=1000):
    ...
    def new_func(*args):
        i = 0
        sum_original_function = 0

        while i < trials_count:
            sum_original_function += original_function(*args)
            i += 1
        return sum_original_function/trials_count
    return new_func
    # END PROBLEM 8
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    """
    # BEGIN PROBLEM 9
    # begin with the smallest number of dice possible
    num_dice = 1
    max_average = 0
    max_num_rolls = 0

    while num_dice <= 10:
        new_average = make_averaged(
            roll_dice, trials_count=1000)(num_dice, dice)
        if new_average > max_average:
            max_average = new_average
            max_num_rolls = num_dice
        num_dice += 1
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    free_bacon_or_not = bacon_strategy(
        score, opponent_score, cutoff, num_rolls)
    free_bacon_score_gain = free_bacon(opponent_score)
    free_bacon_score = score + free_bacon_score_gain
    triggers_extra_turn = extra_turn(free_bacon_score, opponent_score)

    if (triggers_extra_turn == True):
        return 0
    elif (free_bacon_or_not == 0) and (triggers_extra_turn == False):
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
